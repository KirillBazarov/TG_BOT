                                            ...
                                            inline_keyboard=[
                                                [
                                                    InlineKeyboardButton(
                                                        ...
                                                        callback_data=idk_first_type_get_name.new(fund_number="first_fund")),
                                                    InlineKeyboardButton(
                                                        text=(funsd.get("first_fund_type").get("second_fund").get(
                                                            "name")),
                                                        callback_data=idk_first_type_get_name.new(fund_number="second_fund")),
                                                ],
                                                [
                                                    InlineKeyboardButton(
                                                        text=funsd.get("first_fund_type").get("third_fund").get("name"),
                                                        callback_data=idk_first_type_get_name.new(fund_number="third_fund")),
                                                    InlineKeyboardButton(
                                                        text=(funsd.get("first_fund_type").get("fourth_fund").get(
                                                            "name")),
                                                        callback_data=idk_first_type_get_name.new(fund_number="fourth_fund")),
                                                ],
                                                [
                                                    InlineKeyboardButton(
                                                        text=funsd.get("first_fund_type").get("fifth_fund").get("name"),
                                                        callback_data=idk_first_type_get_name.new(fund_number="fifth_fund")),
                                                    InlineKeyboardButton(
                                                        text=(funsd.get("first_fund_type").get("sixth_fund").get(
                                                            "name")),
                                                        callback_data=idk_first_type_get_name.new(fund_number="sixth_fund")),
                                                ],
                                                [
                                                    InlineKeyboardButton(
                                                        text=funsd.get("first_fund_type").get("seventh_fund").get(
                                                            "name"),
                                                        callback_data=idk_first_type_get_name.new(fund_number="seventh_fund")),
                                                    InlineKeyboardButton(
                                                        text=(funsd.get("first_fund_type").get("eighth_fund").get(
                                                            "name")),
                                                        callback_data=idk_first_type_get_name.new(fund_number="eighth_fund")),
                                                ],
                                                [
                                                    stepback_button,
                                                ]
